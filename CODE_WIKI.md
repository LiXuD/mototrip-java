...
**位置**：[mototrip-common/src/main/java/com/mototrip/common/response/Result.java](file:///workspace/mototrip-common/src/main/java/com/mototrip/common/response/Result.java)
...
**位置**：[mototrip-gateway/src/main/java/com/mototrip/gateway/filter/JwtAuthGlobalFilter.java](file:///workspace/mototrip-gateway/src/main/java/com/mototrip/gateway/filter/JwtAuthGlobalFilter.java)
...
**位置**：[mototrip-auth-server/src/main/java/com/mototrip/auth/service/impl/AuthServiceImpl.java](file:///workspace/mototrip-auth-server/src/main/java/com/mototrip/auth/service/impl/AuthServiceImpl.java)
...
**位置**：[mototrip-common/src/main/java/com/mototrip/common/context/UserContext.java](file:///workspace/mototrip-common/src/main/java/com/mototrip/common/context/UserContext.java)
